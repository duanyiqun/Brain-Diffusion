...
def main(args):
    ...
    try:
        for dataslice in tqdm(dataset_generator):
            ...
            latent = spectro.single_wave_to_latent(wave=dataslice[0].numpy())
            # print(latent.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./braindiffusion/dataset/bci_iv/spectro_dp")
    parser.add_argument(
        "--resolution",
        type=str,
        default="31,64",
    ...
    parser.add_argument("--hop_length", type=int, default=25)
