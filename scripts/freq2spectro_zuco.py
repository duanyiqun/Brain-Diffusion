...
def main(args):
    ...
    try:
        for dataslice in tqdm(train_set):
            ...
            latent = input_embeddings.unsqueeze(0).numpy()[:,:args.max_crop,:]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./dataset/zuco/freqmap_32_840")
    parser.add_argument(
        "--resolution",
        type=str,
        default="32,840", # x_res should be n -1 due to dummy resolution
    ...
    parser.add_argument("--max_crop", type=int, default=32)
