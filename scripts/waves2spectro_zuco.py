...
def main(args):
    ...
    try:
        for dataslice in tqdm(train_set):
            ...
            raw_wave=sent_level_EEG.unsqueeze(0).numpy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./dataset/zuco/stft-96-64")
    parser.add_argument(
        "--resolution",
        type=str,
        default="96,64", # x_res should be n -1 due to dummy resolution
